...
(
    ...
    CONSTRAINT fk_reading_session_book FOREIGN KEY (book_id) REFERENCES book (book_id),
    CONSTRAINT fk_reading_session_chapter FOREIGN KEY (book_chapter_id) REFERENCES book_chapter (book_chapter_id),
    CONSTRAINT fk_reading_session_user FOREIGN KEY (user_id) REFERENCES user (user_id)
) ENGINE=InnoDB
